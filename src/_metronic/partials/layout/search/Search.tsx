  ...
  return (
    <>
      ...
      >
        ...
        >
          <div className='btn btn-icon btn-active-light-primary w-30px h-30px w-md-40px h-md-40px border border-gray-300'>
          <KTSVG path="/media/icons/duotune/general/gen021.svg" className="svg-icon-dark svg-icon-1" />
          </div>
        </div>
